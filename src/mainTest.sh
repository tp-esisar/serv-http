...
visualTest "get1" "Host-header" #trouve et callback mais segfault après
visualTest "get1" "Host" #trouve et callback mais segfault après
visualTest "get1" "method" #marche OK
echo "-------------------------fin tests visuels----------------------------"
echo
echo "-------------debut tests unitaires sur fichiers de test---------------"
#visualTest get1 "HTTP-version" 
